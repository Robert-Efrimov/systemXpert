...
<head>
    ...
    <script src="js/añadirPro.js"></script>
...
<div class="barra1">
    ...
    <div class="añadirP container">
        <div class="añT">Añade tu producto</div>
        <form action="confirmarAña.php" method="post" name="formulario3" id="formulario3"  enctype="multipart/form-data">
            ...
            <div>
            <input type="number" name="precio" id="precio" class="añI">
            <small></small>
            </div>

            <div class="añN">Cantidad</div>
            <div>
            <input type="number" name="cantidad" id="cantidad" class="añI">
            <small></small>
            </div>
            ...
            <div>
            <textarea rows="4" name="descripcion"  id="descripcion" cols="37"></textarea>
            <small></small>
            </div>

            <div class="añN">Imagén</div>
            <div>
            <input type="file" name="img" id="img" accept=".png, .jpeg">
            <small></small>
            </div>
