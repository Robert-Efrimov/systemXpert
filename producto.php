    ...
    ?>
            <div class="container prod">
                ...
                <div class="p2">
                    ...
                    <div class="but">
                        <button class="but1 add-to-cart" data-product-id="<?php echo $row["idProducto"] ?>"><img src="img/carrito.png" class="bcar" alt=""></button>
...
<div class="titc">Opiniones</div>
    ...
    <div>
        <form action="opinion.php" method="POST">
            ...
            <div class="botO1">
                <input type="submit" class="botO" name="enviar" value="Añadir Comentario">
            </div>
        </form>
    </div>
    <div>
